...
public class CourseEngagement {
    ...
    public int getEnrollmentMonth() { return enrollmentMonth; }

    public int getEnrollmentYear() { return enrollmentYear; }

    public int getLastLecture() { return lastLecture; }

    public int getLastActiveMonth() { return lastActiveMonth; }

    public int getLastActiveYear() { return lastActiveYear; }

    public double getPercentComplete(int lectureCount) { return lastLecture * 100.0 / lectureCount; }
